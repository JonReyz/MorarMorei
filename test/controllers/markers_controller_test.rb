...
class MarkersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create marker" do
    assert_difference('Marker.count') do
      post markers_url, params: { marker: { address: @marker.address, description: @marker.description, latitude: @marker.latitude, longitude: @marker.longitude, positive: @marker.positive } }
    end
  ...
  test "should update marker" do
    patch marker_url(@marker), params: { marker: { address: @marker.address, description: @marker.description, latitude: @marker.latitude, longitude: @marker.longitude, positive: @marker.positive } }
